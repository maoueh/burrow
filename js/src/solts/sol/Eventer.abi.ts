...
export namespace Eventer {
  ...
  export const bytecode =
    '';
        ...
        Init(
          ...
          return client.listen(
            ...
            (err?: Error | EndOfStream, log?: LogEvent) => {
              ...
              return callback(undefined, decode(client, log?.getData_asU8(), log?.getTopicsList_asU8()).Init());
            },
            range,
          );
        },
        MonoRampage(
          ...
          return client.listen(
            ...
            (err?: Error | EndOfStream, log?: LogEvent) => {
              ...
              return callback(undefined, decode(client, log?.getData_asU8(), log?.getTopicsList_asU8()).MonoRampage());
            },
            range,
          );
        },
